...
function update2(){
  ...
  d3.selectAll('circle').remove();
  var yMax = joist2.F*(joist2.l-joist2.a)/(9*Math.sqrt(3)*joist2.E*joist2.Iy*joist2.l)*Math.pow(Math.pow(joist2.l,2)-Math.pow(joist2.l-joist2.a,2),3/2);
  console.log(yMax);
  ...
  for(var x=m1; x<parseFloat(joist2.l)+m1; x+=parseFloat(joist2.resolution)){
    var y = 0;
    if((x-m1)<joist2.a && joist2.a < joist2.l/2){
      y=joist2.F*(joist2.l-joist2.a)/(6*joist2.E*joist2.Iy*10e5*joist2.l)*(Math.pow(joist2.l,2)*(x-m1)-Math.pow(joist2.l-joist2.a,2)*(x-m1)-Math.pow((x-m1),3));
    } else if ((x-m1)>joist2.a && joist2.a < joist2.l/2){
      y=joist2.F*(joist2.l-joist2.a)/(6*joist2.E*joist2.Iy*10e5*joist2.l)*(joist2.l/(joist2.l-joist2.a)*Math.pow((x-m1)-joist2.a,3)+(Math.pow(joist2.l,2)-Math.pow(joist2.l-joist2.a,2))*(x-m1)-Math.pow((x-m1),3));
    } /*else if ((x-m1)<(joist2.l-joist2.a) && (joist2.l-joist2.a) < joist2.l/2){
      y=joist2.F*(joist2.l-(joist2.l-joist2.a))/(6*joist2.E*joist2.Iy*10e5*joist2.l)*(Math.pow(joist2.l,2)*(x-m1)-Math.pow(joist2.l-(joist2.l-joist2.a),2)*(x-m1)-Math.pow((x-m1),3));
    } else if((x-m1)>(joist2.l-joist2.a) && (joist2.l-joist2.a) < joist2.l/2){
      y=joist2.F*(joist2.l-(joist2.l-joist2.a))/(6*joist2.E*joist2.Iy*10e5*joist2.l)*(joist2.l/(joist2.l-(joist2.l-joist2.a))*Math.pow((x-m1)-(joist2.l-joist2.a),3)+(Math.pow(joist2.l,2)-Math.pow(joist2.l-(joist2.l-joist2.a),2))*(x-m1)-Math.pow((x-m1),3));
    } */else{
      y = 0;
    }
    var color = '#000000';
